                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown messages-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="label label-danger fontsize14">4</span>
                        </a>
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="../bower_components/admin-lte/dist/img/avatar5.png" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Support Team
                    ...
                    <li class="dropdown notifications-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="label label-danger fontsize14">10</span>
                        </a>
                        <ul class="dropdown-menu">
...
<!--                    <a href="#"><i class="fa fa-circle text-success"></i> Online</a>-->
                    <a href="#"><i class="fa fa-battery-0 text-success"></i> Newbie</a>
                </div>
            </div>
            <!-- search form -->

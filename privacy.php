...
<div style="padding: 20px;">
    <div style="border: 2px solid green; padding: 20px;"><center><strong>Privacy Notice</strong></center>
        <p>This privacy notice discloses the privacy practices for <span style="text-decoration: underline;">(https://lazylearn.com)</span>. This privacy notice applies solely to information collected by this website. It will notify you of the following:</p>
        <ol type="1">
